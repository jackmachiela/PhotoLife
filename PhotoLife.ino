...
//           
//           Originally, no available MAX7219 libraries allowed the setup of a matrix other than 8*x - however, matdombrock
//           modified his MatrixGL library just for this purpose. https://github.com/matdombrock/MatrixGL/
//
//           NB - At this time, the matrixability is in experimental mode only. I will update when MatrixGL goes live.
//
